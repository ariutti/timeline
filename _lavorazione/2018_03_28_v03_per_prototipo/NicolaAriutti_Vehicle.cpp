...
void NicolaAriutti_Vehicle::init(float _x, float _ms, float _mf, int _damp)
{
	acceleration = 0.0;
	velocity = 0.0;
	position = _x;
...
void NicolaAriutti_Vehicle::update()
{
...
void NicolaAriutti_Vehicle::setTarget(float _target)
{
	target = _target;
}


float NicolaAriutti_Vehicle::getPosition()
{
	return position;
}
